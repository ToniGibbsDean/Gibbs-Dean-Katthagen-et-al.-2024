...
################################################################################################################################################
    ...
    #set seed and load pacakges 
        ...
        genpop2<- genpop2tibble %>%
            ...
            L3_realEsts<-read.csv("Outputs/L3_REAL_meanEsts_F_genpop.csv")
            L3_simEsts<-read.csv("Outputs/L3_SIM_meanEsts_F_genpop.csv")
            
            L4_realEsts<-read.csv("Outputs/L4_REAL_meanEsts_F_genpop.csv")
            L4_simEsts<-read.csv("Outputs/L4_SIM_meanEsts_F_genpop.csv")
            
            L5_realEsts<-read.csv("Outputs/L5_REAL_meanEsts_F_genpop.csv")
            L5_simEsts<-read.csv("Outputs/L5_SIM_meanEsts_F_genpop.csv")
            
            L6_realEsts<-read.csv("Outputs/L6_REAL_meanEsts_F_genpop.csv")
            L6_simEsts<-read.csv("Outputs/L6_SIM_meanEsts_F_genpop.csv")
    ...
    #data re BW estimates 
            L3_realEsts_BW<-read.csv("Outputs/L3_REAL_BWests_F_genpop.csv")
            L3_simEsts_BW<-read.csv("Outputs/L3_SIM_BWEsts_F_genpop.csv")
            
            L4_realEsts_BW<-read.csv("Outputs/L4_REAL_BWests_F_genpop.csv")
            L4_simEsts_BW<-read.csv("Outputs/L4_SIM_BWests_F_genpop.csv")
            
            L5_realEsts_BW<-read.csv("Outputs/L5_REAL_BWests_F_genpop.csv")
            L5_simEsts_BW<-read.csv("Outputs/L5_SIM_BWests_F_genpop.csv")
            
            L6_realEsts_BW<-read.csv("Outputs/L6_REAL_BWests_F_genpop.csv")
            L6_simEsts_BW<-read.csv("Outputs/L6_SIM_BWests_F_genpop.csv")
...
########################################################################################################
        ...
        L6plots_rev<-plotting.SIMvsEST.sd(ParticipantRoverPos_df= L6_realEsts, SimRoverPos_df=L6_simEsts, L6_realEsts_BW, L6_simEsts_BW, 6, "forward")
                    ...
                    ggsave(simVSest_plot, file=file.path(path,"simVSest_plots_GENPOP.pdf"))
