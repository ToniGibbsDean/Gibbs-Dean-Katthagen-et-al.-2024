...
close all
    ...
    homepath = '/Users/tg625/Documents/PDA/Directory/BeliefUpdating_Psychosis_HierarchicalGaussianFilter/'; % Toni 
    addpath(fullfile(homepath, 'Code/04_ComputationalModelling/tapas-master/HGF/'));
    data_path =(fullfile('/Users/tg625/Documents/PDA/Directory/BeliefUpdating_Psychosis_HierarchicalGaussianFilter/Outputs/'));
...
idx = 0; 
for level = 6 % goes through levels
