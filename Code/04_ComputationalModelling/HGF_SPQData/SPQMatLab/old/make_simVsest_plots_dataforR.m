...
load est_spq_forward_level6.mat
...
writetable(meansim, 'L6_SIM_meanEsts_F_spq.csv')

meanposreal=table(mean_real);
%writetable(meanposreal, 'L6_REAL_meanEsts.csv')
writetable(meanposreal, 'L6_REAL_meanEsts_F_spq.csv')

bwsim=table(bw_sim);
%writetable(bwsim, "L6_SIM_BWests.csv")
writetable(bwsim, "L6_SIM_BWests_F_spq.csv")

bwreal=table(bw_real);
%writetable(bwreal, "L6_REAL_BWests.csv")
writetable(bwreal, "L6_REAL_BWests_F_spq.csv")
