function tapas_ehgf_jget_spacetask_plotTraj(r)
...
if plotsd == true
    upper = r.traj.muxhat(:,1)+1.96*sqrt(r.p_obs.zem +r.traj.sauhat(:,1)); % before: saxhat! 
    lower = r.traj.muxhat(:,1)-1.96*sqrt(r.p_obs.zem +r.traj.sauhat(:,1));
